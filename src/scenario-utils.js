...
export function toInteractionsWithConfig(input, scenarios) {
    return scenarios
        .map(scenario => {
...
export function findReplaceRule(replaceRules, i, numOf) {
...
export function toTechnology(technology) {
...
export function toInteractions(input, numOfInteractions = 1) {
    const interactions = []
...
export function toHeaders(headerFile, headers, defaultHeaders) {
    if (headerFile) {
...
export function toInteractionTemplate(interaction) {
...
export function toGenerateAlways(inputGenerateAlways, interactionGenerateAlways) {
    return [
...
export function toGenerateConstants(generateConstants) {
